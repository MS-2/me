(function () {
    ...
    var counterBlock = document.getElementById("g-count");
    ...
    window.addEventListener('load', function () {
        ...
        invaderAsset.src = "https://i.pinimg.com/564x/a3/91/71/a39171a408dcf1cfcdfcbd1477e5565b.jpg";
    ...
    function initGameStart() {
        if (window.innerWidth > 1440) {
            ...
            screen.canvas.width = 560;
            screen.canvas.height = 360;
            gameSize = {
                width: 560,
                height: 360
            };
            invaderMultiplier = 1;
            initialOffsetInvader = 240;
        } else if (window.innerWidth > 767) {
            screen.canvas.width = 660;
            screen.canvas.height = 500;
            gameSize = {
                width: 660,
                height: 500
            ...
            invaderMultiplier = 2;
            initialOffsetInvader = 220;
        } else if (window.innerWidth > 360) {
            screen.canvas.width = 320;
            ...
            invaderMultiplier = 1;
            initialOffsetInvader = 180;
        }
        else {
            screen.canvas.width = 280;
            screen.canvas.height = 260;
            gameSize = {
                width: 280,
                height: 260
            };
